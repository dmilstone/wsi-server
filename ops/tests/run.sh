...
python3 "$OPS_DIR/tests/test_wsi_ingest_network_drop.py"
pass "network-drop ingest unit tests"
python3 "$OPS_DIR/tests/test_wsi_service_control.py"
pass "service launch/quit controller unit tests"
python3 "$OPS_DIR/tests/test_wsi_ops_dashboard.py"
pass "ops dashboard unit tests"
