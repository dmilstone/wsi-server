...
assert.doesNotMatch(adapterSource, /ensureSidebarOcrScanButton/);
assert.doesNotMatch(adapterSource, /runSidebarLabelOcr/);
assert.match(adapterSource, /scheduleSidebarClinicalOcrBatch/);
assert.match(adapterSource, /runSidebarClinicalOcrBatch/);
assert.match(adapterSource, /beginOcrPendingDisplay/);
assert.match(adapterSource, /SIDEBAR_OCR_CONCURRENCY/);
assert.match(adapterSource, /const OcrSessionCache\s*=\s*\{\s*\}/);
assert.match(adapterSource, /writeOcrSessionCache/);
assert.match(adapterSource, /hasOcrSessionCacheEntry/);
assert.match(adapterSource, /OcrSessionCache\[/);
...
assert.match(adapterSource, /renderOcrClinicalMarker/);
assert.match(adapterSource, /extractIfEpitopeMarker/);
assert.match(adapterSource, /clearAllOcrResultText/);
assert.match(adapterSource, /if\\\.\\S\+/);
...
assert.match(html, /\.ocr-result-text\s*\{[\s\S]*?color:\s*#00ffcc/);
assert.match(html, /\.ocr-result-text\s*\{[\s\S]*?font-weight:\s*bold/);
assert.match(html, /\.ocr-result-text\s*\{[\s\S]*?margin-top:\s*1px/);
assert.match(html, /\.ocr-result-text\s*\{[\s\S]*?line-height:\s*1/);
assert.match(html, /ocr-result-pending/);
assert.match(html, /clearAllOcrResultText/);
...
assert.match(adapterSource, /ensureSidebarOcrResultNode/);
assert.match(adapterSource, /image-button-label[\s\S]*?\.after\(result\)|label\.after\(result\)/);
...
assert.match(html, /annotation-adapter\.js\?v=20260815-ocr-session-cache/);
