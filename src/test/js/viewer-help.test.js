...
assert.match(index, /Multi-view; Cell display; Display \(Show analysis, Brightness\/Contrast, overlay 400%–1%\); Set tool/);
...
assert.match(directory, /href="\/help\/viewer-guide\.html\?v=20260911"/);
