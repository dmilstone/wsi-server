...
assert.match(index, /Lock\/Unlock Position, Delete, or Set class for the selected annotation\(s\)/);
...
assert.match(directory, /href="\/help\?v=20260911-hier"/);
assert.match(directory, /id="viewer-quick-guide-link"/);
assert.match(directory, /href="\/help\/viewer-guide\.html\?v=20260911-hier"/);
assert.match(directory, /id="admin-ops-guide-link"/);
assert.match(directory, /href="\/help\/admin-ops-guide\.html\?v=20260911-hier"/);
