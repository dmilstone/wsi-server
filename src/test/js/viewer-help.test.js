...
assert.match(index, /Show channel viewer; Multi-view grid size/);
...
assert.match(index, /Lock\/Unlock Position or Delete the selected annotation\(s\)/);
...
assert.match(directory, /href="\/help\?v=20260910"/);
assert.match(directory, /id="viewer-quick-guide-link"/);
assert.match(directory, /href="\/help\/viewer-guide\.html\?v=20260910"/);
assert.match(directory, /id="admin-ops-guide-link"/);
assert.match(directory, /href="\/help\/admin-ops-guide\.html\?v=20260910"/);
